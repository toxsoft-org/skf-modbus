 ...
 * @author hazard157
 */
public final class MbTreePath
    implements Comparable<MbTreePath> {

  /**
   * Singleton of the kind {@link EMbNodePathKind#ROOT}.
   */
  public static final MbTreePath ROOT_PATH = new MbTreePath();
  ...
  private MbTreePath( String aBridgeId ) {
  ...
  private MbTreePath( String aBridgeId, String aBusId ) {
    bridgeId = StridUtils.checkValidIdPath( aBridgeId );
  ...
  private MbTreePath( String aBridgeId, String aBusId, String aNodeId ) {
    bridgeId = StridUtils.checkValidIdPath( aBridgeId );
    busId = StridUtils.checkValidIdPath( aBusId );
   ...
   * @return {@link MbTreePath} - created instance
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   * @throws TsIllegalArgumentRtException any non <code>null</code> ID is not an IDpath
   */
  public static MbTreePath of( EMbNodePathKind aKind, String aBridgeId, String aBusId, String aNodeId ) {
    TsNullArgumentRtException.checkNull( aKind );
    return switch( aKind ) {
      case ROOT -> ROOT_PATH;
      case BRIDGE -> new MbTreePath( aBridgeId );
      case BUS -> new MbTreePath( aBridgeId, aBusId );
      case NODE -> new MbTreePath( aBridgeId, aBusId, aNodeId );
    };
  }
   ...
   */
  public static MbTreePath ofBridge( String aBridgeId ) {
    return new MbTreePath( aBridgeId );
  }
   ...
   */
  public static MbTreePath ofBus( String aBridgeId, String aBusId ) {
    return new MbTreePath( aBridgeId, aBusId );
  }
   ...
   * @throws TsIllegalArgumentRtException any ID is not an IDpath
   */
  public static MbTreePath ofNode( String aBridgeId, String aBusId, String aNodeId ) {
    return new MbTreePath( aBridgeId, aBusId, aNodeId );
  }
  ...
  public boolean equals( Object aThat ) {
    ...
    if( aThat instanceof MbTreePath that ) {
  ...
  @Override
  public int compareTo( MbTreePath aThat ) {
    if( aThat == null ) {
