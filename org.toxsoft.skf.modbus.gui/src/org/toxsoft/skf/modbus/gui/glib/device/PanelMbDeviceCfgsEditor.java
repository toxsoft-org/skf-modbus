 ...
 * @author hazard157
 */
public class PanelMbDeviceCfgsEditor
   ...
   */
  public PanelMbDeviceCfgsEditor( Composite aParent, ITsGuiContext aContext, boolean aViewer,
    ...
    model = m5().getModel( MbDeviceCfgM5Model.MODEL_ID, MbDeviceCfg.class );
