...
public interface IMbBusRtuCfg
   ...
   */
  @Override
  IStridablesList<IMbNodeRtuCfg> listNodeCfgs();
   ...
   * @param aRtuDevAddr int - device address on the bus
   * @param aParams {@link IOptionSet} - parameters
   * @return {@link ValidationResult} - the check result
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  ValidationResult canAddNode( String aNodeId, String aDeviceId, int aRtuDevAddr, IOptionSet aParams );
   ...
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   * @throws TsValidationFailedRtException failed {@link #canAddNode(String, String, int, IOptionSet)}
   */
  IMbNodeRtuCfg addNode( String aNodeId, String aDeviceId, int aRtuDevAddr, IOptionSet aParams );
